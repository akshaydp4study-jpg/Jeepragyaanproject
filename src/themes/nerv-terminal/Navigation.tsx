...
import { LayoutDashboard, Atom, FlaskConical, Sigma, ClipboardCheck, Settings, BrainCircuit } from 'lucide-react';
...
export default function Navigation({ mobileMenuOpen, setMobileMenuOpen }: NavigationProps) {
  ...
  return (
    <aside className="w-full lg:w-64 bg-bg-panel border-r lg:border-b-0 border-border-subtle flex flex-col min-h-full select-none font-rajdhani">
      {/* Brand Header */}
